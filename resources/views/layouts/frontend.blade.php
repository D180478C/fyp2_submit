                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @can('users_info_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.users-infos.index') }}">
                                    ...
                                    @endcan -->
                                    @can('task_access')
                                    <a class="dropdown-item ml-3" href="{{ route('frontend.tasks-calendars.index') }}">
                                        tasks calendars
                                    </a>
                                    @endcan
                                    ...
                                    @can('appointment_time_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.appointment-times.index') }}">
                                    ...
                                    @can('illness_tag_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.illness-tags.index') }}">
                                            {{ trans('cruds.illnessTag.title') }}
                                        </a>
                                    @endcan
                                    @can('vaccine_tag_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.vaccine-tags.index') }}">
