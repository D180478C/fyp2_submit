    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.users-infos.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="nric_no" id="nric_no" value="{{ old('nric_no', '') }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="birth_date" id="birth_date" value="{{ old('birth_date') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <a href="{{route('frontend.home')}}" class="btn btn-danger"> << Back </a>
                        </div>
                    </form>
                </div>
            </div>
